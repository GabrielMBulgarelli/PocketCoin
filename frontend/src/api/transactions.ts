...
export type TransactionCreate = { financial_account_id: number | null; category_id: number; transaction_date: string; kind: "income" | "expense"; amount_minor: number; description: string; notes: string | null; is_debt_payment?: boolean; tag_ids?: number[]; recurrence?: { frequency: "weekly" | "monthly" | "yearly"; end_date: string | null } };
export type TransferCreate = { from_account_id: number | null; to_account_id: number | null; transaction_date: string; amount_minor: number; description: string; notes: string | null };
